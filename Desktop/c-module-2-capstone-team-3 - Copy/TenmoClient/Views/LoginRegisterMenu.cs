    ...
    public class LoginRegisterMenu : ConsoleMenu
    {
        ...
        private MenuOptionResult Login()
        {
            ...
            while (user == null)
            {
                ...
                user = authService.Login(loginUser);//if logging fails, then null is returned
                if (user == null)
                {
                    //telling the user the login info is incorrect is now handled by AuthService
            ...
            return new MainMenu(authService).Show();
        }
        ...
        private MenuOptionResult Register()
        {
            ...
            while (!isRegistered)
            {
                ...
                if (!isRegistered)
                {
                    ...
                    //error reporting is handled by authservice
                }
            }
            Console.WriteLine("");
